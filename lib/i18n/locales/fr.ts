...
export const fr = {
  ...
  operations_page: {
    ...
    subtitle: "Suivi des interventions terrain, déploiements As-Built et maintenance.",
    filter_type: "Filtrer par Type",
    filter_status: "Filtrer par Statut",
    no_ops: "Aucune opération trouvée",
    total_ops: "Total Opérations",
    active_now: "En Cours",
    completed: "Validées",
