...
// Guideline fix: imported getAiClient instead of global ai instance to ensure instance is created right before call
import { getAiClient, AI_MODELS, generateNetworkContextPrompt } from '../../lib/ai/client';
...
const GponAssistant: React.FC = () => {
  ...
  const getContext = () => {
    ...
    return {
        ...
        pcos: pcos.length,
        // Corrected property name from saturatedNodes to criticalRisks
        saturatedNodes: metrics.criticalRisks,
        warningNodes: metrics.warningNodes,
        // Corrected property name from offline to critical
        incidents: health.critical + health.maintenance,
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Guideline fix: initialize new client right before call
      const ai = getAiClient();
      
      // Guideline fix: use simple text contents and text property for response
      ...
      // Guideline fix: access .text property directly
