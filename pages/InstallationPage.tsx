...
import { Coordinates, InstallationResult, Equipment, FiberCable } from '../types';
  ...
  return (
    <div className="flex h-full w-full relative overflow-hidden">
      ...
      `}>
        ...
        {isViewer && (
          <div className="mb-6 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl flex items-center gap-2 text-blue-600 dark:text-cyan-400 text-xs font-bold animate-in fade-in slide-in-from-top-2">
          ...
          <div className="space-y-6 animate-in slide-in-from-left duration-300 pb-20">
            ...
            {result.nearestPCO && (
              <div className="space-y-4">
                ...
                {/* Le bouton de génération d'OT est masqué pour les consultants */}
                {result.feasible && !isViewer && (
                ...
                {result.feasible && isViewer && (
                   <div className="p-4 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-800 rounded-xl text-emerald-700 dark:text-emerald-400 text-xs font-medium text-center">
                     Étude validée techniquement par le SIG.
                   </div>
                )}
              </div>
            )}
      ...
      <div className="flex-1 relative h-full">
        ...
        <GponMap 
          center={{ lat: DEFAULT_VIEW_STATE.lat, lng: DEFAULT_VIEW_STATE.lng }}
          onMapClick={handleMapClick}
          selectedEntity={result?.nearestPCO as Equipment}
